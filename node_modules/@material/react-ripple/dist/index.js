...
var withRipple = function withRipple(WrappedComponent) {
  var RippledComponent = function (_Component) {
    ...
    function RippledComponent() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RippledComponent.__proto__ || Object.getPrototypeOf(RippledComponent)).call.apply(_ref, [this].concat(args))), _this), _this.foundation_ = null, _this.state = {
        classList: new Set(),
        style: {}
      }, _this.initializeFoundation_ = function (instance) {
        var adapter = _this.createAdapter_(instance);
        _this.foundation_ = new _ripple.MDCRippleFoundation(adapter);
        _this.foundation_.init();
      }, _this.createAdapter_ = function (instance) {
        var MATCHES = _ripple.util.getMatchesProperty(HTMLElement.prototype);
        ...
        return {
          ...
          isSurfaceActive: function isSurfaceActive() {
            return instance[MATCHES](':active');
          },
          ...
          registerDocumentInteractionHandler: function registerDocumentInteractionHandler(evtType, handler) {
            return document.documentElement.addEventListener(evtType, handler, _ripple.util.applyPassive());
          },
          deregisterDocumentInteractionHandler: function deregisterDocumentInteractionHandler(evtType, handler) {
            return document.documentElement.removeEventListener(evtType, handler, _ripple.util.applyPassive());
          },
        ...
        requestAnimationFrame(function () {
          _this.foundation_.activate(e);
        });
      }, _this.deactivateRipple = function (e) {
        _this.foundation_.deactivate(e);
    ...
    _createClass(RippledComponent, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            otherProps = _objectWithoutProperties(_props, ['unbounded', 'style', 'className', 'onMouseDown', 'onMouseUp', 'onTouchStart', 'onTouchEnd', 'onKeyDown', 'onKeyUp']);

        var updatedProps = Object.assign(otherProps, {
        ...
        return _react2.default.createElement(WrappedComponent, updatedProps);
      }
    }, {
      key: 'classes',
      get: function get() {
        var wrappedCompClasses = this.props.className;
        var classList = this.state.classList;

        return (0, _classnames2.default)(Array.from(classList), wrappedCompClasses);
      }
    }]);
  ...
  WrappedComponent.propTypes = Object.assign({
    unbounded: _propTypes2.default.bool,
